...
class _AnnouncementDetailState extends State<AnnouncementDetail> {
  ...
  void updateUserExp() async {
    ...
    if (exp!.containsKey(widget.announceData['activity_tag'])) {
      exp[widget.announceData['activity_tag']] =
          (exp[widget.announceData['activity_tag']]! as int) + 1;
      ...
      exp[widget.announceData['activity_tag']] = 1;
      await FirebaseFirestore.instance
          .collection('users')
          .doc(user_id)
          .update({'exp': exp});
